...
func easyjsonF248ab8DecodeGithubComCharlesDBurtonGomeas(in *jlexer.Lexer, out *Button) {
...
func easyjsonF248ab8EncodeGithubComCharlesDBurtonGomeas(out *jwriter.Writer, in Button) {
	out.RawByte('{')
	first := true
	_ = first
	if in.CommandTopic != "" {
...
func (v Button) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonF248ab8EncodeGithubComCharlesDBurtonGomeas(&w, v)
...
func (v *Button) UnmarshalJSON(data []byte) error {
	...
	easyjsonF248ab8DecodeGithubComCharlesDBurtonGomeas(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Button) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonF248ab8DecodeGithubComCharlesDBurtonGomeas(l, v)
}
