...
func easyjsonC6317731DecodeGithubComCharlesDBurtonGomeas(in *jlexer.Lexer, out *Camera) {
	...
	for !in.IsDelim('}') {
		...
		switch key {
		case "image_encoding":
			out.ImageEncoding = string(in.String())
		case "topic":
...
func easyjsonC6317731EncodeGithubComCharlesDBurtonGomeas(out *jwriter.Writer, in Camera) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ImageEncoding != "" {
		const prefix string = ",\"image_encoding\":"
		first = false
		out.RawString(prefix[1:])
		out.String(string(in.ImageEncoding))
	}
	if in.Topic != "" {
...
func (v Camera) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonC6317731EncodeGithubComCharlesDBurtonGomeas(&w, v)
...
func (v *Camera) UnmarshalJSON(data []byte) error {
	...
	easyjsonC6317731DecodeGithubComCharlesDBurtonGomeas(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Camera) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonC6317731DecodeGithubComCharlesDBurtonGomeas(l, v)
}
